...
import 'package:ipp_starter_kit/commands/change_package_name.dart';
import 'package:ipp_starter_kit/commands/create.dart';
import 'package:ipp_starter_kit/commands/create_app_icon.dart';
...
Future<void> main(List<String> args) async {
  final runner = CommandRunner('ipp', 'Official CLI for IPP xD')
    ...
    ..addCommand(ChangePackageNameCommand())
    ..addCommand(ChangeAppIconsCommand())
